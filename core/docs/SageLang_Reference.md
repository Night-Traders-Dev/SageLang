...
> **Version:** 4.2.10 | **Spec Version:** 2.0 | **License:** MIT
...
**Soft keywords** (v4.0.0+): `print`, `end`, `match`, `init`, `enum`, `struct`, `trait` — can be used as variable, property, or method names where unambiguous.
