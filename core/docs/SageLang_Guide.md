...
| **Functions** | First-class `proc` declarations with closures; anonymous `proc` expressions (`proc(x): body end` or `proc(x): body`); native C functions; bare `end` nil-expression statements |
