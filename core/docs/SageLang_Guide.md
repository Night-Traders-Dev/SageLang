...
### 9.21 ESP32 Board Support (`core/lib/esp32.sage`, `core/boards/ESP32/`)

SageLang features board support and hardware mapping for the **classic ESP32** (ESP32-D0WD-V3, ESP-WROOM-32 / DevKitC, 4MB SPI flash): dual-core Xtensa LX6 @ 240MHz with 2.4GHz WiFi.
