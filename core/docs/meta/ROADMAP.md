...
- **v4.2.9** — GC allocation-accounting and root-scan races, a per-thread
  ...
  single-owner GPU lifecycle, parallel unit-test execution, and a documentation
  pass over stale status files.
...
- **GC root traversal is not a true stop-the-world.** Marking is concurrent and
  ...
  robust.
- **The roadmap and parity documents were stale** until v4.2.9: the phase list
  was headed v3.8.5, and PARITY.md carried two contradictory verdicts. Both are
  corrected, and this file now points at CHANGELOG.md as the authoritative
...
## v4.1.3: Math Matrix Printing & CLI Enhancements (June 2026)
...
## v4.1.3: VM Optimization & Self-Hosted Toolchain (June 2026)
...
## v4.1.3: Sentinel Security & Performance Refinement (May 2026)
...
## v4.1.3: Performance Optimizations + Kotlin Fixes (April 2026)
...
## v4.1.3: Kotlin/Android Backend (April 2026)
...
## v4.1.3: ORC Garbage Collector (April 2026)
...
## v4.1.3: QEMU Support (March 2026)
