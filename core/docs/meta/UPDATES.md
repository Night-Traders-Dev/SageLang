...
## v3.8.0 — Phase 19: "Gotcha" Fixes & Performance Optimization (June 14, 2026)
...
- **Version Bump**: Milestone v3.8.0 release.
...
## v3.7.8 — Math Matrix Printing & CLI Enhancements (June 2026)
...
## v3.7.7 (In Progress) — SGVM Self-Hosting Support
...
- **Version Bump**: Milestone v3.7.5 release.

## v3.7.4 — VM Optimization & Native Features (June 2026)
...
- **Version Bump**: Milestone v3.7.4 release.

## v3.7.3 — Hotfix: Doc Comment Restoration (May 2026)
...
- **Version Bump**: Milestone v3.7.3 release.

## v3.7.2 — Hotfix: Structural Uniqueness, Repeating, and Sandbox Import Guards (May 2026)
...
- **Version Bump**: Milestone v3.7.2 release.

## v3.7.1 — Hotfix: Synchronization Primitives (May 2026)
...
- **Version Bump**: Milestone v3.7.1 release.

## v3.7.0 — Self-Hosted Compiler Parity & Stability (May 2026)
...
- **Core Stability**:
  - Finalized v3.7.0 concurrency refinements and prepared the codebase for the v3.7.0 milestone.
  - Cleaned up build system references and ensured single-source versioning across all tools.
- **Documentation Refactoring**:
  - Major update to the SageLang Book and system guides to reflect the 3.7.0 architecture.
- **Version Bump**: Milestone v3.7.0 release.

---

## v3.6.9 — Concurrency & Async Refinement (May 2026)
...
- **Documentation Refresh**:
  - Synchronized all documentation across `README.md`, `core/docs/`, and `core/documentation/` for the v3.6.9 release.
- **Version Bump**: Updated to v3.6.9 across all core files and documentation.
...
## v3.6.7 — Sentinel Security & Performance Refinement (May 2026)
...
## v3.6.6 — JIT+AOT Hybrid Default + SageMetal VM (April 2026)
...
## v3.6.5 — JIT+AOT Hybrid Default Runtime (April 2026)
...
## v3.6.4 — Documentation Refresh + Benchmark Expansion (April 2026)
...
- Version bump to v3.6.4

---

## v3.6.3 — Hybrid JIT/AOT + Vulkan/OpenGL Android + Full Concurrency (April 2026)
...
## v3.6.2 — Vulkan/OpenGL Android + Full Concurrency (April 2026)
...
## v3.6.1 — Full Concurrency: Atomics, Semaphores, SMP, Multicore, Hyperthreading (April 2026)
...
## v3.6.0 — Native Speed + Book Update (April 2026)
...
## v3.5.4 — Performance Optimizations + Kotlin Fixes (April 2026)
...
## v3.5.3 — Kotlin/Android Backend (April 2026)
...
## v3.5.2 — ORC Garbage Collector (April 2026)
...
## v3.5.1 — Specification Lock + REPL JIT/AOT (March 2026)
...
- Version unified across all components: `VERSION` file is single source of truth
  - net.c User-Agent now uses `SAGE_VERSION_STR` macro (was hardcoded 3.5.1)
  - Makefile help target uses `$(SAGE_VERSION)` (was hardcoded 3.5.1)
...
## v3.5.0 — QEMU Support (March 2026)
...
## v3.4.2 — Phase 18: Linux Kernel Support (March 2026)
...
- **June 9, 2026**: v3.4.0: Integrated One-line Install System (OIS), optimized `dicts.size` to $O(1)$, achieved $O(N)$ array uniqueness, implemented high-performance native library built-ins for array reversal (~105x), added REPL `:stats` command, and introduced GPIO interrupt management.
- **June 8, 2026**: v3.3.2: Implemented `sys.call` for dynamic native/closure invocation and reached full opcode parity in MetalVM (OOP, Exceptions, GPU).
...
- **May 29, 2026**: v3.3.1: Fixed doc comment detachment for `errno.strerror` and updated core metadata.
- **May 25, 2026**: v3.3.0: Structural value equality in uniqueness checks, safe non-hanging string/value repeating, and robust sandbox security guards.
- **May 20, 2026**: v3.2.1: Critical bug fix in `mutex_lock` for bare-metal targets.
- **May 15, 2026**: v3.2.0: Milestone release: Self-hosted compiler parity and synchronization primitives stabilization.
