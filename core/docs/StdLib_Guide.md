...
let fields = {"port": 8080, "host": "4.1.3.0"}
...
| `gpio` | `import metal.gpio` | `gpio_init`, `pin_mode`, `pin_pull`, `pin_set_interrupt`, `pin_enable_interrupt`, `pin_disable_interrupt`, `pin_enable_interrupt_ext`, `pin_disable_interrupt_ext`, `digital_write`, `digital_read`, `led_blink`, `pin_debounce` |
