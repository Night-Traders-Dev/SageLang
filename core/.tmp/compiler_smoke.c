...
static SageValue sage_fn_accumulate_2(SageValue arg0);
static SageValue sage_fn_fib_1(SageValue arg0);

static SageSlot sage_global_answer_4;
static SageSlot sage_global_counter_3;

void sage_gc_mark_program_globals(void) {
    if (sage_global_answer_4.defined) sage_gc_mark_value(sage_global_answer_4.value);
    if (sage_global_counter_3.defined) sage_gc_mark_value(sage_global_counter_3.value);
}


static SageValue sage_fn_fib_1(SageValue arg0) {
    SageSlot sage_param_n_5 = sage_slot_undefined();
    SageSlot* sage_gc_roots[1] = {&sage_param_n_5};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 1);
    sage_define_slot(&sage_param_n_5, arg0);
    if (sage_truthy(SAGE_LTE(sage_load_slot(&sage_param_n_5, "n"), sage_number(1)))) {
        return sage_gc_return(&sage_gc_frame, sage_load_slot(&sage_param_n_5, "n"));
    }
    return sage_gc_return(&sage_gc_frame, SAGE_ADD(sage_fn_fib_1(SAGE_SUB(sage_load_slot(&sage_param_n_5, "n"), sage_number(1))), sage_fn_fib_1(SAGE_SUB(sage_load_slot(&sage_param_n_5, "n"), sage_number(2)))));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_fn_accumulate_2(SageValue arg0) {
    SageSlot sage_local_current_8 = sage_slot_undefined();
    SageSlot sage_local_total_7 = sage_slot_undefined();
    SageSlot sage_param_limit_6 = sage_slot_undefined();
    SageSlot* sage_gc_roots[3] = {&sage_local_current_8, &sage_local_total_7, &sage_param_limit_6};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 3);
    sage_define_slot(&sage_param_limit_6, arg0);
    sage_define_slot(&sage_local_total_7, sage_number(0));
    sage_define_slot(&sage_local_current_8, sage_number(1));
    while (sage_truthy(SAGE_LTE(sage_load_slot(&sage_local_current_8, "current"), sage_load_slot(&sage_param_limit_6, "limit")))) {
        (void)sage_assign_slot(&sage_local_total_7, "total", SAGE_ADD(sage_load_slot(&sage_local_total_7, "total"), sage_load_slot(&sage_local_current_8, "current")));
        (void)sage_assign_slot(&sage_local_current_8, "current", SAGE_ADD(sage_load_slot(&sage_local_current_8, "current"), sage_number(1)));
    }
    return sage_gc_return(&sage_gc_frame, sage_load_slot(&sage_local_total_7, "total"));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}
...
int main(int argc, char** argv) {
    ...
    sage_global_answer_4 = sage_slot_undefined();
    sage_global_counter_3 = sage_slot_undefined();
    SageSlot* sage_gc_global_roots[2] = {&sage_global_answer_4, &sage_global_counter_3};
    SageGcFrame sage_gc_main_frame;
    sage_gc_push_frame(&sage_gc_main_frame, sage_gc_global_roots, 2);
    sage_define_slot(&sage_global_counter_3, sage_number(0));
    while (sage_truthy(SAGE_LT(sage_load_slot(&sage_global_counter_3, "counter"), sage_number(3)))) {
        (void)sage_assign_slot(&sage_global_counter_3, "counter", SAGE_ADD(sage_load_slot(&sage_global_counter_3, "counter"), sage_number(1)));
    }
    sage_print_ln(sage_load_slot(&sage_global_counter_3, "counter"));
    sage_define_slot(&sage_global_answer_4, sage_fn_fib_1(sage_number(6)));
    sage_print_ln(sage_load_slot(&sage_global_answer_4, "answer"));
    sage_print_ln(sage_fn_accumulate_2(sage_number(5)));
    sage_print_ln(SAGE_ADD(sage_string("fib="), sage_str(sage_fn_fib_1(sage_number(5)))));
    if (sage_truthy(SAGE_EQ(sage_load_slot(&sage_global_answer_4, "answer"), sage_number(8)))) {
        sage_print_ln(sage_string("phase10-ok"));
    }
    else {
        sage_print_ln(sage_string("phase10-bad"));
    }
