...
static SageSlot sage_global_literal_4;
static SageSlot sage_global_i_3;
static SageSlot sage_global_total_2;
static SageSlot sage_global_nums_1;

void sage_gc_mark_program_globals(void) {
    if (sage_global_literal_4.defined) sage_gc_mark_value(sage_global_literal_4.value);
    if (sage_global_i_3.defined) sage_gc_mark_value(sage_global_i_3.value);
    if (sage_global_total_2.defined) sage_gc_mark_value(sage_global_total_2.value);
    if (sage_global_nums_1.defined) sage_gc_mark_value(sage_global_nums_1.value);
}
...
int main(int argc, char** argv) {
    ...
    sage_global_literal_4 = sage_slot_undefined();
    sage_global_i_3 = sage_slot_undefined();
    sage_global_total_2 = sage_slot_undefined();
    sage_global_nums_1 = sage_slot_undefined();
    SageSlot* sage_gc_global_roots[4] = {&sage_global_literal_4, &sage_global_i_3, &sage_global_total_2, &sage_global_nums_1};
    SageGcFrame sage_gc_main_frame;
    sage_gc_push_frame(&sage_gc_main_frame, sage_gc_global_roots, 4);
    sage_define_slot(&sage_global_nums_1, sage_range2(sage_number(1), sage_number(6)));
    (void)sage_push(sage_load_slot(&sage_global_nums_1, "nums"), sage_number(8));
    sage_print_ln(sage_len(sage_load_slot(&sage_global_nums_1, "nums")));
    sage_print_ln(SAGE_ADD(sage_index(sage_load_slot(&sage_global_nums_1, "nums"), sage_number(0)), sage_index(sage_load_slot(&sage_global_nums_1, "nums"), sage_number(4))));
    sage_print_ln(sage_pop(sage_load_slot(&sage_global_nums_1, "nums")));
    sage_print_ln(sage_slice(sage_load_slot(&sage_global_nums_1, "nums"), sage_number(1), sage_number(4)));
    sage_define_slot(&sage_global_total_2, sage_number(0));
    sage_define_slot(&sage_global_i_3, sage_number(0));
    while (sage_truthy(SAGE_LT(sage_load_slot(&sage_global_i_3, "i"), sage_len(sage_load_slot(&sage_global_nums_1, "nums"))))) {
        (void)sage_assign_slot(&sage_global_total_2, "total", SAGE_ADD(sage_load_slot(&sage_global_total_2, "total"), sage_index(sage_load_slot(&sage_global_nums_1, "nums"), sage_load_slot(&sage_global_i_3, "i"))));
        (void)sage_assign_slot(&sage_global_i_3, "i", SAGE_ADD(sage_load_slot(&sage_global_i_3, "i"), sage_number(1)));
    }
    sage_define_slot(&sage_global_literal_4, sage_make_array(3, (SageValue[]){sage_number(10), sage_number(20), sage_number(30)}));
    sage_print_ln(sage_index(sage_load_slot(&sage_global_literal_4, "literal"), sage_number(2)));
    sage_print_ln(sage_load_slot(&sage_global_total_2, "total"));
    sage_print_ln(sage_slice(sage_load_slot(&sage_global_literal_4, "literal"), sage_number(0), sage_number(2)));
