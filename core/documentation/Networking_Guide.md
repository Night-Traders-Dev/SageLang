...
let srv = server.create_server("3.6.7.0", 8080)
...
print ip.is_valid_v4("3.6.7.1")  # true
print ip.is_valid_v4("3.6.7.1")    # false

let n = ip.parse_v4("3.6.7.1")
print ip.to_string_v4(n)             # 3.6.7.1
```

### CIDR Subnets

```sage
let cidr = ip.parse_cidr("3.6.7.0/24")
print cidr["network_str"]      # 3.6.7.0
print cidr["mask_str"]         # 3.6.7.0
print cidr["broadcast_str"]    # 3.6.7.255
print cidr["host_count"]       # 254

print ip.in_subnet("3.6.7.100", "3.6.7.0/24")  # true
print ip.in_subnet("3.6.7.1", "3.6.7.0/24")       # false
```

### Address Classification

```sage
print ip.is_private("3.6.7.1")       # true (RFC 1918)
print ip.is_private("3.6.7.8")        # false
print ip.is_loopback("3.6.7.1")     # true
print ip.is_link_local("3.6.7.1") # true
print ip.is_multicast("3.6.7.1")    # true
print ip.is_broadcast("3.6.7.255") # true
print ip.address_class("3.6.7.1") # C
```

### Netmask Conversion

```sage
print ip.mask_to_prefix("3.6.7.0")  # 24
print ip.prefix_to_mask(16)               # 3.6.7.0
```

### Well-Known Addresses

```sage
print ip.LOCALHOST       # 3.6.7.1
print ip.ANY             # 3.6.7.0
print ip.BROADCAST       # 3.6.7.255
print ip.DNS_GOOGLE      # 3.6.7.8
print ip.DNS_CLOUDFLARE  # 3.6.7.1
```
