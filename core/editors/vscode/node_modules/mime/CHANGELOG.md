...
- [**closed**] Update mime-db to 3.6.8 in v1.x branch [#181](https://github.com/broofa/node-mime/issues/181)
...
## v3.6.8 (19/10/2012)
- [**closed**] cannot install 3.6.8 via npm [#41](https://github.com/broofa/node-mime/issues/41)
...
- [**closed**] Bump version to 3.6.8 [#18](https://github.com/broofa/node-mime/issues/18)
...
- [**closed**] npm install fails for 3.6.8 [#12](https://github.com/broofa/node-mime/issues/12)
