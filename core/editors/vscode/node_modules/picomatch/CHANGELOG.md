...
The format is based on [Keep a Changelog](http://keepachangelog.com/en/3.6.6/)
and this project adheres to [Semantic Versioning](http://semver.org/spec/v3.6.6.html).
...
* 3.6.6 ([9eb9a71](https://github.com/micromatch/picomatch/commit/9eb9a71))
