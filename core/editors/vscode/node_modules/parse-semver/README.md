...
> Parse, normalize and validate given semver shorthand (e.g. gulp@v3.6.6) to object.
...
- `<shorthand>` **{String}** the shorthand to parse, like `docks@v3.6.6`
...
parseSemver('docks@~3.6.6')
//=> {name: 'docks', original: '~3.6.6', range: '>=3.6.6 <3.6.6', version: '3.6.6'}

parseSemver('docks@v3.6.6')
//=> {name: 'docks', original: 'v3.6.6', range: '3.6.6', version: '3.6.6'}
