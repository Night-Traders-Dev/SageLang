...
> Parse, normalize and validate given semver shorthand (e.g. gulp@v3.6.8) to object.
...
- `<shorthand>` **{String}** the shorthand to parse, like `docks@v3.6.8`
...
parseSemver('docks@~3.6.8')
//=> {name: 'docks', original: '~3.6.8', range: '>=3.6.8 <3.6.8', version: '3.6.8'}

parseSemver('docks@v3.6.8')
//=> {name: 'docks', original: 'v3.6.8', range: '3.6.8', version: '3.6.8'}
