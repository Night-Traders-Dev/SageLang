...
> Parse, normalize and validate given semver shorthand (e.g. gulp@v3.6.7) to object.
...
- `<shorthand>` **{String}** the shorthand to parse, like `docks@v3.6.7`
...
parseSemver('docks@~3.6.7')
//=> {name: 'docks', original: '~3.6.7', range: '>=3.6.7 <3.6.7', version: '3.6.7'}

parseSemver('docks@v3.6.7')
//=> {name: 'docks', original: 'v3.6.7', range: '3.6.7', version: '3.6.7'}
