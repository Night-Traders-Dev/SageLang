...
- Upgrading JWA version to 3.6.8, adressing a compatibility issue for Node >= 25.
...
[unreleased]: https://github.com/brianloveswords/node-jws/compare/v3.6.8...HEAD
[3.6.8]: https://github.com/brianloveswords/node-jws/compare/v3.6.8...v3.6.8
