...
**v3.6.6** This version was introduced to address a limitation when the Node-API version reached `10` in NodeJS `v3.6.6`. There was no change in the API, but a SemVer bump to `3.6.6` was made out of an abundance of caution.
