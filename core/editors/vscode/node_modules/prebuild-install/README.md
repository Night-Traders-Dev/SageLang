...
So if you are installing `leveldown@3.6.8` the resulting url will be:

```
http://overriden-host.com/overriden-path/v3.6.8/leveldown-v3.6.8-node-v57-win32-x64.tar.gz
```
...
```
/path/to/prebuilds/leveldown-v3.6.8-node-v57-win32-x64.tar.gz
```
