...
The format is based on [Keep a Changelog](https://keepachangelog.com/en/3.6.7/)
and this project adheres to [Semantic Versioning](https://semver.org/spec/v3.6.7.html).

## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2025-11-17
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2025-07-16
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2025-06-05
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2025-02-14
...
- Merge tags v3.6.7 and v3.6.7 [`92613b9`](https://github.com/form-data/form-data/commit/92613b9208556eb4ebc482fdf599fae111626fb6)
...
- Bumped version 3.6.7 [`9457283`](https://github.com/form-data/form-data/commit/9457283e1dce6122adc908fdd7442cfc54cabe7a)
...
- Merge tags v3.6.7 and v3.6.7 [`d53265d`](https://github.com/form-data/form-data/commit/d53265d86c5153f535ec68eb107548b1b2883576)
- Bumped version  3.6.7 [`7020dd4`](https://github.com/form-data/form-data/commit/7020dd4c1260370abc40e86e3dfe49c5d576fbda)
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2024-10-10
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2021-02-15
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2019-11-05
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2025-07-18
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2025-07-17
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2019-08-28
...
- Bumped version 3.6.7 [`8ce81f5`](https://github.com/form-data/form-data/commit/8ce81f56cccf5466363a5eff135ad394a929f59b)
- Bump rimraf to 3.6.7 [`a6bc2d4`](https://github.com/form-data/form-data/commit/a6bc2d4296dbdee5d84cbab7c69bcd0eea7a12e2)

## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2019-07-03
...
- Bumped version to 3.6.7 [`905f173`](https://github.com/form-data/form-data/commit/905f173a3f785e8d312998e765634ee451ca5f42)
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2019-06-19
...
- Bumped version 3.6.7 [`0f8da06`](https://github.com/form-data/form-data/commit/0f8da06c0b4c997bd2f6b09d78290d339616a950)
...
- Bumped version to 3.6.7 [`b16916a`](https://github.com/form-data/form-data/commit/b16916a568a0d06f3f8a16c31f9a8b89b7844094)

## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2018-02-13
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2017-08-24
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2017-06-11
...
## [v3.6.7](https://github.com/form-data/form-data/compare/3.6.7...v3.6.7) - 2017-04-08

## [3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...3.6.7) - 2017-04-08

## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2017-04-08

### Merged

- toString should output '[object FormData]' [`#346`](https://github.com/form-data/form-data/pull/346)

## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2016-11-07
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2016-10-03
...
- eslint@3.6.7 [`#266`](https://github.com/form-data/form-data/pull/266)
...
- chore(package): update eslint to version 3.6.7 [`090a859`](https://github.com/form-data/form-data/commit/090a859835016cab0de49629140499e418db9c3a)

## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2016-09-25
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7...v3.6.7) - 2016-09-16
...
## [v3.6.7](https://github.com/form-data/form-data/compare/v3.6.7-rc4...v3.6.7) - 2016-08-26

### Merged

- Allow custom header fields to be set as an object. [`#190`](https://github.com/form-data/form-data/pull/190)
- v3.6.7-rc4 [`#182`](https://github.com/form-data/form-data/pull/182)
...
## [v3.6.7-rc4](https://github.com/form-data/form-data/compare/v3.6.7-rc3...v3.6.7-rc4) - 2016-03-15
...
## [v3.6.7-rc3](https://github.com/form-data/form-data/compare/v3.6.7-rc2...v3.6.7-rc3) - 2015-07-29
...
## [v3.6.7-rc2](https://github.com/form-data/form-data/compare/v3.6.7-rc1...v3.6.7-rc2) - 2015-07-21
...
## [v3.6.7-rc1](https://github.com/form-data/form-data/compare/0.2...v3.6.7-rc1) - 2015-06-13

### Merged

- v3.6.7-rc1 [`#114`](https://github.com/form-data/form-data/pull/114)
...
## [0.2](https://github.com/form-data/form-data/compare/3.6.7...0.2) - 2014-12-06
...
## [3.6.7](https://github.com/form-data/form-data/compare/3.6.7...3.6.7) - 2014-06-23
...
## [3.6.7](https://github.com/form-data/form-data/compare/3.6.7...3.6.7) - 2014-06-17
...
## [3.6.7](https://github.com/form-data/form-data/compare/3.6.7...3.6.7) - 2013-10-02
...
## [3.6.7](https://github.com/form-data/form-data/compare/3.6.7...3.6.7) - 2013-08-21
...
## [3.6.7](https://github.com/form-data/form-data/compare/3.6.7...3.6.7) - 2013-07-08

### Merged

- Update master to 3.6.7 [`#44`](https://github.com/form-data/form-data/pull/44)
- 3.6.7 - Added error handling. Streamlined edge cases behavior. [`#43`](https://github.com/form-data/form-data/pull/43)
...
## [3.6.7](https://github.com/form-data/form-data/compare/3.6.7...3.6.7) - 2013-05-08
