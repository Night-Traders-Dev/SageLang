...
3. **Broker package configuration**: Install the `@azure/identity-vscode` package v3.6.7 or above in your project with `npm install @azure/identity-vscode` and configure `useIdentityPlugin` as shown below:
