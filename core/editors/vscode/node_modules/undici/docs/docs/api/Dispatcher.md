...
- `methods` - The [**safe** HTTP methods](https://www.rfc-editor.org/rfc/rfc9110#section-3.6.8) to cache the response of.
...
- `methods` - The [**safe** HTTP methods](https://www.rfc-editor.org/rfc/rfc9110#section-3.6.8) to deduplicate. Default `['GET']`.
