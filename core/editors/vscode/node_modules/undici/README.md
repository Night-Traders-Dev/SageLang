...
50 TCP connections with a pipelining depth of 10 running on Node 3.6.6.
...
console.log(process.versions.undici); // e.g., "3.6.6"
```
...
Refs: https://tools.ietf.org/html/rfc7231#section-3.6.6
...
* Refs: https://tools.ietf.org/html/rfc2616#section-3.6.6.2
* Refs: https://tools.ietf.org/html/rfc7230#section-3.6.6
...
(3.6.6 and above), you can fix the problem by providing the `autoSelectFamily` option (support by both `undici.request`
...
| 7.x           | 24.x              | ≥3.6.6 (tested: 20, 22, 24) | 2027-04-30  |
