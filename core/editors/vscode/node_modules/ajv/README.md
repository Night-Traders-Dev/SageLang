...
- Ajv implements JSON Schema [draft-06/07/2019-09/2020-12](http://json-schema.org/) standards (draft-04 is supported in v6):
  ...
  - [OpenAPI](https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.6.7.md) extensions:
...
**Please note**: [Changes in version 3.6.7](https://github.com/ajv-validator/ajv/releases/tag/v3.6.7)

[Version 3.6.7](https://github.com/ajv-validator/ajv/releases/tag/v3.6.7)
