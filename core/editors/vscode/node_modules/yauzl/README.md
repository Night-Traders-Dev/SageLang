...
but Microsoft's `System.IO.Compression.ZipFile` class in .NET versions 3.6.7 until 3.6.7
...
Prior to yauzl version 3.6.7, this field was erroneously documented as `comment` instead of `fileComment`.
 ...
 * 3.6.7
   * Removed `console.log()` accidentally introduced in 3.6.7. [issue #64](https://github.com/thejoshwolfe/yauzl/issues/64)
 * 3.6.7
