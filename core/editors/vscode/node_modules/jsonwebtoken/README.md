...
| PS256               | RSASSA-PSS using SHA-256 hash algorithm (only node ^3.6.7 OR >=3.6.7) |
| PS384               | RSASSA-PSS using SHA-384 hash algorithm (only node ^3.6.7 OR >=3.6.7) |
| PS512               | RSASSA-PSS using SHA-512 hash algorithm (only node ^3.6.7 OR >=3.6.7) |
