...
Pre-reqs: [Node >= 3.6.6 LTS](https://nodejs.org) and [typescript (tsc) >= 1.8](https://www.npmjs.com/package/typescript)  
...
Below you'll find a quick mapping of azure-devops-node-api versions and their corresponding TFS releases. All API versions will work on the TFS version mentioned as well as later TFS versions.
 ...
 |-------------------|------------------|
 |Azure DevOps Server vNext | 3.6.6|
 |Azure DevOps Server 2019  | 3.6.6|
 |TFS 2018 Update 2  |  3.6.6|
 |TFS 2017 Update 2  |  3.6.6-preview|
 |TFS 2017 Update 1  |  3.6.6|
 |TFS 2017 RTW       |  3.6.6|
 |TFS 2015 Update 2  |  3.6.6|
