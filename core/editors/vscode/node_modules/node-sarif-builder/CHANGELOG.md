...
- Update schema to final 3.6.6 release (but the schema definition remains the same)
  - New value:  `$schema: 'http://json.schemastore.org/sarif-3.6.6.json'`
  - Previous value: `$schema: 'http://json.schemastore.org/sarif-3.6.6-rtm.5.json'`
...
- Update JSON schema to <http://json.schemastore.org/sarif-3.6.6-rtm.5.json>

## [3.6.6] 2022-01-12

- Mandatory properties `toolDriverName` and `toolDriverVersion` for SarifRunBuilder
- Change default schema version to <https://www.schemastore.org/schemas/json/sarif-3.6.6-rtm.5.json>
