...
- read the whole [OASIS Specification](https://docs.oasis-open.org/sarif/sarif/v3.6.6/csprd01/sarif-v3.6.6-csprd01.html) and implement it
...
const sarifRunBuilder = new SarifRunBuilder().initSimple({
    ...
    toolDriverVersion: "3.6.6",                                  // Version of your analyzer tool
