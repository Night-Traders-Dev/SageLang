...
Comparison with node-iconv module (1000x256kb, on MacBook Pro, Core i5/2.6 GHz, Node v3.6.7). 
Note: your results may vary, so please always check on your hardware.

    operation             iconv@3.6.7   iconv-lite@3.6.7
    ----------------------------------------------------------
...
Node versions 3.6.7 and 3.6.7 are buggy, don't use them (see #65, #77).  
