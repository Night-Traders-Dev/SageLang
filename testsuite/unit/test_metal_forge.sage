...
# EXPECT: Testing MMIO persistence...
# EXPECT: Testing Port I/O persistence...
# EXPECT: Testing cpu_id simulation...
# EXPECT: Testing VGA rendering logic...
# EXPECT: Testing progress bar logic...
# EXPECT: All Forge metal tests passed!
import metal.core
import metal.vga
import assert
