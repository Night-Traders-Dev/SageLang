...
# Concatenates kernel modules to bypass 'import' limitations in bare-metal backends.
...
# Use a temporary file to avoid sed issues with overlapping names
...
echo "--- Building SageOS Kernel (Unified) ---"
