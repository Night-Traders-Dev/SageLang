...
**Current version:** v4.1.3 · **Spec version:** 2.0 · **License:** MIT

## Recent Updates

- **v4.1.3 (Veritas Quality Audit & Submodule Stabilization)**: Audited standard test suites and resolved duplicate function definition issue in `crypto/hash.sage` (duplicate `rotate_left` declarations) and `net/dns.sage` (duplicate `parse_rrs` parsing calls).
