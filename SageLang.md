...
> **Version:** 3.9.5 | **Spec Version:** 2.0 | **License:** MIT  
...
**Soft keywords** (v3.9.5+): `match`, `init`, `enum`, `struct`, `trait` — can be used as variable names in expressions and assignments.
