...
> **Version:** 3.8.5 | **Spec Version:** 2.0 | **License:** MIT  
...
**Soft keywords** (v3.8.5+): `match`, `init`, `enum`, `struct`, `trait` — can be used as variable names in expressions and assignments.
